...
const Chart = (props) => {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-screen-md mt-4 p-6 pb-6 bg-base-200/50 rounded-xl shadow-sm sm:p-8">
      <h2 className="text-xl font-bold">Monthly Commits</h2>
      <span className="text-sm font-semibold uppercase tracking-wider text-base-content/60">Last six months</span>
