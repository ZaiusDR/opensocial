  ...
  return (
    <div>
      ...
      <p>
        ...
        automatically try to collect them, gather activity stats and present
        them in a single place, so others can find their project to which
        contribute with?
      </p>
      ...
      <p>
        The <b>objective</b> is to give the people the possibility to find a
      ...
      <p>
        ...
        the number of <b>Contributors</b> of a project. I got inspired by the
        <a href={"https://github.com/ossf/criticality_score"}> Criticality
          Score Project
        </a>, and just implemented a simplified version of their algorithm.
      </p>
      <h3><b>Finally</b></h3>
      <p>
        As developers we have the opportunity to be part of the Open Source
        philosophy beauty, to have an impact in society. So... <b>Let's code a
        better World!! 🦄</b>
      </p>
    </div>
  )
...
export default WhyModalContent
