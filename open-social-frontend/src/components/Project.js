...
import { EyeOutlined, ExclamationCircleOutlined, ForkOutlined, PullRequestOutlined, TeamOutlined, StarOutlined } from '@ant-design/icons';
      ...
      <Row>
        <Col span={24} className="Project" align='middle'>
          ...
          <Col span={24} className="Project-details">
            ...
            <Divider/>
            <div><b><TeamOutlined style={{color: '#00334e'}}/> Contributors:</b> {props.project.contributors}</div>
            <div><b><ExclamationCircleOutlined style={{color: 'red'}}/> Open Issues:</b> {props.project.open_issues}</div>
            <div><b><PullRequestOutlined style={{color: 'green'}}/> Total Commits:</b> {props.project.total_commits}</div>
          </Col>
          <Collapse ghost>
            <Panel header={<b>More details</b>} key={1}>
              <Row className="Stats">
                <Col span={12} className="Stats-activity">
                  <div><b><EyeOutlined style={{color: '#00334e'}}/> Watchers:</b> {props.project.watchers}</div>
                  <div><b><StarOutlined style={{color: '#00334e'}}/> Stargazers:</b> {props.project.stargazers}</div>
                  <div><b><ForkOutlined style={{color: '#00334e'}}/> Forks:</b> {props.project.forks}</div>
                </Col>
          ...
          <Col span={24} className="Graph-data" style={{marginBottom: '16px'}}>
