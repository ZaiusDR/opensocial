          ...
          <Header style={{ width: '100%', height: '35vw', padding: 0 }}>
            ...
            >
              <div style={{ maxHeight: 'inherit', transform: 'translateY(50%)' }}>
                ...
                <Image style={{ display: 'block', transform: 'translateY(-20%)' }} width={'100%'} preview={false} src={'collaboration-heart-medium.jpg'} alt={'collaboration'} />
              </div>
              <div style={{ maxHeight: 'inherit', transform: 'translateY(50%)' }}>
                <Image style={{ display: 'block', transform: 'translateY(-20%)' }} width={'100%'} preview={false} src={'open-source.jpg'} alt={'open source'} />
              </div>
              <div style={{ maxHeight: 'inherit', transform: 'translateY(50%)' }}>
                <Image style={{ display: 'block', transform: 'translateY(-20%)' }} width={'100%'} preview={false} src={'community.jpg'} alt={'community'} />
              </div>
            </Carousel>
          </Header>
